...
func (m *MockBannerRepository) CheckUnique(arg0 int) ([]uint, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) CheckUniqueByFeature(arg0 uint) ([]uint, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) CheckUniqueByTags(arg0 []uint, arg1 uint) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) CreateBanner(arg0 model.Banner) (uint, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) DeleteBanner(arg0 model.Banner) error {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) GetBanners(arg0 model.GetBanners) ([]model.BannerResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) GetBannersByFeature(arg0 model.GetBanners) ([]model.BannerResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) GetBannersByTag(arg0 model.GetBanners) ([]model.BannerResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) GetUserBanner(arg0 model.GetUserBanner, arg1 bool) (model.BannerContent, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) GetUserBannerWithTags(arg0 model.GetBanners, arg1 bool) (model.BannerResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockBannerRepository) UpdateBanner(arg0 model.UpdateBanner) error {
	m.ctrl.T.Helper()
